...
namespace code
{
    ...
    /// </summary>
    [Guid("f2eb5be5-8f82-4e25-8f44-428911ce2443")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("code.cmdEditStop")]
    public sealed class cmdEditStop : BaseCommand
    {
        ...
        public cmdEditStop(AxMapControl ax)
        {
            //
            ...
            try
            {
                ...
                //
                string bitmapResourceName = @"D:\YNU\Subject\senior\gisÈí¼þ¿ª·¢\program\ex6\main\img\cmdEditStop.bmp";
